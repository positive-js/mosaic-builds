...
let McSidepanelContainerComponent = class McSidepanelContainerComponent extends BasePortalOutlet {
...
let McSidepanelService = class McSidepanelService {
 ...
 */
let McSidepanelClose = class McSidepanelClose {
 ...
 */
let McSidepanelHeader = class McSidepanelHeader {
};
__decorate([
    Input(),
 ...
 */
let McSidepanelBody = class McSidepanelBody {
};
 ...
 */
let McSidepanelFooter = class McSidepanelFooter {
};
 ...
 */
let McSidepanelActions = class McSidepanelActions {
};
...
let McSidepanelModule = class McSidepanelModule {
};
