...
import { McPopUp, McPopUpTrigger, PopUpSizes } from '@ptsecurity/mosaic/core';
...
export declare class McPopoverTrigger extends McPopUpTrigger<McPopoverComponent> {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<McPopoverTrigger, "[mcPopover]", ["mcPopover"], { "hasBackdrop": "hasBackdrop"; "header": "mcPopoverHeader"; "content": "mcPopoverContent"; "footer": "mcPopoverFooter"; "disabled": "mcPopoverDisabled"; "trigger": "mcTrigger"; "size": "mcPopoverSize"; "customClass": "mcPopoverClass"; "closeOnScroll": "closeOnScroll"; "backdropClass": "backdropClass"; }, {}, never>;
}
