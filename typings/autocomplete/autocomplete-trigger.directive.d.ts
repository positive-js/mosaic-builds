...
export declare class McAutocompleteTrigger implements ControlValueAccessor, OnDestroy {
    ...
    readonly activeOption: McOption | null;
    ...
    constructor(elementRef: ElementRef<HTMLInputElement>, viewContainerRef: ViewContainerRef, changeDetectorRef: ChangeDetectorRef, overlay: Overlay, zone: NgZone, scrollStrategy: any, dir: Directionality, formField: McFormField, document: any, viewportRuler?: ViewportRuler);
    ngOnDestroy(): void;
     ...
     */
    readonly panelClosingActions: Observable<McOptionSelectionChange | null>;
