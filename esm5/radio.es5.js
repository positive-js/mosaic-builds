...
var McRadioButton = /** @class */ (function (_super) {
    ...
    McRadioButton.decorators = [
        { type: Component, args: [{
                    ...
                    styles: [".mc-radio-button{display:inline-block}.mc-radio-label{cursor:pointer;display:inline-flex;align-items:center;white-space:nowrap;vertical-align:middle}.mc-radio-label-content{display:inline-block;order:0;line-height:inherit;padding-right:0}[dir=rtl] .mc-radio-label-content{padding-right:26px;padding-left:0}.mc-radio-input{position:absolute;outline:0;opacity:0}.mc-radio-input+.mc-radio-label-content{position:relative;cursor:pointer;padding-left:26px}.mc-radio-input+.mc-radio-label-content:before{position:absolute;left:0;top:-1px;content:'';background:#fff;width:16px;height:16px;display:block;box-shadow:inset 0.0.1-f912eafpx 0 rgba(0,0,0,.2);border-width:1px;border-style:solid;border-radius:50%;border-color:#b3b3b3}.mc-radio-input+.mc-radio-label-content:after{content:'';top:5px;left:6px;width:6px;height:6px;border-radius:50%;position:absolute;opacity:0}.mc-radio-input:hover+.mc-radio-label-content:before{background-color:rgba(0,0,0,.06)}.mc-radio-input:checked+.mc-radio-label-content:after{opacity:1;background:#fff}.mc-radio-input:checked+.mc-radio-label-content:before{box-shadow:unset;background:#338fcc;border-color:#206ea2}.mc-radio-input:checked:hover+.mc-radio-label-content:after{opacity:1;background:#b3b3b3}.mc-radio-input:focus+.mc-radio-label-content:before{top:-2px;left:-1px;box-shadow:inset 0 0.0.1-f912eafpx #fff;border-width:2px;border-color:#338fcc}.mc-radio-input[disabled]{cursor:default}.mc-radio-input[disabled]+.mc-radio-label-content{cursor:default}.mc-radio-input[disabled]+.mc-radio-label-content:before{background:#f5f5f5;border-color:#e6e6e6}.mc-radio-input[disabled]+.mc-radio-label-content:after{background:#ccc}"],
