...
McTabLabel.ctorParameters = function () { return CdkPortal.ctorParameters; };
...
var McTabGroup = /** @class */ (function (_super) {
    ...
    McTabGroup.prototype.subscribeToTabLabels = function () {
        ...
        this.tabLabelSubscription = merge.apply(void 0, this.tabs.map(function (tab) { return tab.stateChanges; })).subscribe(function () { return _this.changeDetectorRef.markForCheck(); });
    };
    ...
    McTabGroup = __decorate([
        ...
        __param(2, Inject(MC_TABS_CONFIG)), __param(2, Optional()),
        __metadata("design:paramtypes", [ElementRef,
