...
import { Directive, TemplateRef, Component, ChangeDetectionStrategy, ViewEncapsulation, ViewContainerRef, ContentChild, ViewChild, Input, ElementRef, Optional, ChangeDetectorRef, Output, ComponentFactoryResolver, Inject, forwardRef, EventEmitter, NgZone, ContentChildren, InjectionToken, Attribute, NgModule } from '@angular/core';
