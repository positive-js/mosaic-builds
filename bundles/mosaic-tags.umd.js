...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@ptsecurity/cdk/coercion'), require('@ptsecurity/cdk/keycodes'), require('@ptsecurity/mosaic/core'), require('@ptsecurity/mosaic/icon'), require('rxjs'), require('rxjs/operators'), require('@angular/forms'), require('@ptsecurity/cdk/a11y'), require('@ptsecurity/cdk/bidi'), require('@ptsecurity/cdk/collections'), require('@ptsecurity/mosaic/form-field'), require('@angular/common'), require('@ptsecurity/cdk/platform')) :
	typeof define === 'function' && define.amd ? define('@ptsecurity/mosaic/tags', ['exports', '@angular/core', '@ptsecurity/cdk/coercion', '@ptsecurity/cdk/keycodes', '@ptsecurity/mosaic/core', '@ptsecurity/mosaic/icon', 'rxjs', 'rxjs/operators', '@angular/forms', '@ptsecurity/cdk/a11y', '@ptsecurity/cdk/bidi', '@ptsecurity/cdk/collections', '@ptsecurity/mosaic/form-field', '@angular/common', '@ptsecurity/cdk/platform'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.mosaic = global.ng.mosaic || {}, global.ng.mosaic.tags = {}),global.ng.core,global.ng.cdk.coercion,global.ng.cdk.keycodes,global.ng.mosaic.core,global.ng.mosaic.icon,global.rxjs,global.rxjs.operators,global.ng.forms,global.ng.cdk.a11y,global.ng.cdk.bidi,global.ng.cdk.collections,global.ng.mosaic.formField,global.ng.common,global.ng.cdk.platform));
}(this, (function (exports,core,coercion,keycodes,core$1,icon,rxjs,operators,forms,a11y,bidi,collections,formField,common,platform) { 'use strict';
