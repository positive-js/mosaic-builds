...
(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define('@ptsecurity/mosaic/select', ['exports', '@angular/cdk/bidi', '@angular/cdk/coercion', '@angular/cdk/collections', '@angular/cdk/overlay', '@angular/core', '@angular/forms', '@ptsecurity/cdk/a11y', '@ptsecurity/cdk/keycodes', '@ptsecurity/mosaic/core', '@ptsecurity/mosaic/form-field', '@ptsecurity/mosaic/input', '@ptsecurity/mosaic/tags', 'rxjs', 'rxjs/operators', '@angular/common', '@ptsecurity/mosaic/icon'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.mosaic = global.ng.mosaic || {}, global.ng.mosaic.select = {}),global.ng.cdk.bidi,global.ng.cdk.coercion,global.ng.cdk.collections,global.ng.cdk.overlay,global.ng.core,global.ng.forms,global.ng.cdk.a11y,global.ng.cdk.keycodes,global.ng.mosaic.core,global.ng.mosaic.formField,global.ng.mosaic.input,global.ng.mosaic.tags,global.rxjs,global.rxjs.operators,global.ng.common,global.ng.mosaic.icon));
}(this, (function (exports,bidi,coercion,collections,overlay,core,forms,a11y,keycodes,core$1,formField,input,tags,rxjs,operators,common,icon) { 'use strict';
...
var McSelectSearch = /** @class */ (function () {
    function McSelectSearch(formField$$1) {
        this.searchChangesSubscription = new rxjs.Subscription();
        this.isSearchChanged = false;
        formField$$1.canCleanerClearByEsc = false;
    }
    /**
     * @return {?}
     */
