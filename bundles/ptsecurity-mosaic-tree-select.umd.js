(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/overlay'), require('@angular/common'), require('@angular/core'), require('@ptsecurity/mosaic/core'), require('@ptsecurity/mosaic/icon'), require('@ptsecurity/mosaic/tags'), require('@ptsecurity/mosaic/tree'), require('@angular/cdk/coercion'), require('@angular/cdk/collections'), require('@angular/forms'), require('@ptsecurity/cdk/keycodes'), require('@ptsecurity/mosaic/form-field'), require('rxjs'), require('rxjs/operators'), require('@angular/cdk/bidi')) :
    typeof define === 'function' && define.amd ? define('@ptsecurity/mosaic/tree-select', ['exports', '@angular/cdk/overlay', '@angular/common', '@angular/core', '@ptsecurity/mosaic/core', '@ptsecurity/mosaic/icon', '@ptsecurity/mosaic/tags', '@ptsecurity/mosaic/tree', '@angular/cdk/coercion', '@angular/cdk/collections', '@angular/forms', '@ptsecurity/cdk/keycodes', '@ptsecurity/mosaic/form-field', 'rxjs', 'rxjs/operators', '@angular/cdk/bidi'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.ptsecurity = global.ptsecurity || {}, global.ptsecurity.mosaic = global.ptsecurity.mosaic || {}, global.ptsecurity.mosaic["tree-select"] = {}), global.ng.cdk.overlay, global.ng.common, global.ng.core, global.ptsecurity.mosaic.core, global.ptsecurity.mosaic.icon, global.ptsecurity.mosaic.tags, global.ptsecurity.mosaic.tree, global.ng.cdk.coercion, global.ng.cdk.collections, global.ng.forms, global.mc.cdk.keycodes, global.ptsecurity.mosaic["form-field"], global.rxjs, global.rxjs.operators, global.ng.cdk.bidi));
})(this, (function (exports, i1, i8, i0, i2, i7, i6, tree, coercion, collections, i4, keycodes, i5, rxjs, operators, i3) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    /** @nocollapse */ McTreeSelectTrigger.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.13", ngImport: i0__namespace, type: McTreeSelectTrigger, deps: [], target: i0__namespace.ɵɵFactoryTarget.Directive });
    /** @nocollapse */ McTreeSelectTrigger.ɵdir = i0__namespace.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "12.2.13", type: McTreeSelectTrigger, selector: "mc-tree-select-trigger", ngImport: i0__namespace });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.13", ngImport: i0__namespace, type: McTreeSelectTrigger, decorators: [{
                type: i0.Directive,
    ...
    var McTreeSelect = /** @class */ (function (_super) {
        ...
        function McTreeSelect(elementRef, changeDetectorRef, viewportRuler, ngZone, renderer, defaultErrorStateMatcher, scrollStrategyFactory, rawValidators, mcValidation, dir, parentForm, parentFormGroup, parentFormField, ngControl, ngModel, formControlName) {
            ...
            _this.optionSelectionChanges = rxjs.defer(function () {
                if (_this.options) {
                    return _this.options.changes.pipe(operators.startWith(_this.options), operators.switchMap(function () { return rxjs.merge.apply(void 0, __spreadArray([], __read(_this.options.map(function (option) { return option.onSelectionChange; })))); }));
                }
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.13", ngImport: i0__namespace, type: McTreeSelect, decorators: [{
                type: i0.Component,
                args: [{
            ...
            return [{ type: i0__namespace.ElementRef }, { type: i0__namespace.ChangeDetectorRef }, { type: i1__namespace.ViewportRuler }, { type: i0__namespace.NgZone }, { type: i0__namespace.Renderer2 }, { type: i2__namespace.ErrorStateMatcher }, { type: undefined, decorators: [{
                            type: i0.Inject,
                            ...
                            type: i0.Optional
                        }] }, { type: i5__namespace.McFormField, decorators: [{
                            type: i0.Optional
                    ...
                    type: i0.ViewChild,
                    args: [i1.CdkConnectedOverlay, { static: false }]
                }], hiddenItemsCounter: [{
                    type: i0.ViewChild,
                    ...
                    type: i0.ContentChild,
                    args: [tree.McTreeSelection, { static: false }]
                }], hiddenItemsText: [{
                    type: i0.Input
                }], openedChange: [{
                    type: i0.Output
    ...
    /** @nocollapse */ McTreeSelectModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.13", ngImport: i0__namespace, type: McTreeSelectModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    /** @nocollapse */ McTreeSelectModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.13", ngImport: i0__namespace, type: McTreeSelectModule, declarations: [McTreeSelect, McTreeSelectTrigger], imports: [i8.CommonModule,
            i1.OverlayModule,
            tree.McTreeModule,
            i7.McIconModule,
            i6.McTagsModule,
            i2.McPseudoCheckboxModule], exports: [McTreeSelect, McTreeSelectTrigger, i8.CommonModule] });
    /** @nocollapse */ McTreeSelectModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.13", ngImport: i0__namespace, type: McTreeSelectModule, providers: [i2.MC_SELECT_SCROLL_STRATEGY_PROVIDER], imports: [[
                i8.CommonModule,
                i1.OverlayModule,
                tree.McTreeModule,
                i7.McIconModule,
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.13", ngImport: i0__namespace, type: McTreeSelectModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        imports: [
                            i8.CommonModule,
