...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/overlay'), require('@angular/cdk/portal'), require('@angular/common'), require('@angular/core'), require('@ptsecurity/cdk/a11y'), require('@ptsecurity/mosaic/button'), require('@ptsecurity/mosaic/icon'), require('@ptsecurity/cdk/datetime'), require('rxjs'), require('@angular/cdk/bidi'), require('@ptsecurity/cdk/keycodes'), require('rxjs/operators'), require('@angular/cdk/coercion'), require('@ptsecurity/mosaic/core'), require('@ptsecurity/mosaic/form-field'), require('@angular/animations'), require('@angular/forms'), require('@ptsecurity/mosaic/input')) :
    typeof define === 'function' && define.amd ? define('@ptsecurity/mosaic/datepicker', ['exports', '@angular/cdk/overlay', '@angular/cdk/portal', '@angular/common', '@angular/core', '@ptsecurity/cdk/a11y', '@ptsecurity/mosaic/button', '@ptsecurity/mosaic/icon', '@ptsecurity/cdk/datetime', 'rxjs', '@angular/cdk/bidi', '@ptsecurity/cdk/keycodes', 'rxjs/operators', '@angular/cdk/coercion', '@ptsecurity/mosaic/core', '@ptsecurity/mosaic/form-field', '@angular/animations', '@angular/forms', '@ptsecurity/mosaic/input'], factory) :
    (global = global || self, factory((global.ng = global.ng || {}, global.ng.mosaic = global.ng.mosaic || {}, global.ng.mosaic.datepicker = {}), global.ng.cdk.overlay, global.ng.cdk.portal, global.ng.common, global.ng.core, global.ng.cdk.a11y, global.ng.mosaic.button, global.ng.mosaic.icon, global.ng.cdk.datetime, global.rxjs, global.ng.cdk.bidi, global.ng.cdk.keycodes, global.rxjs.operators, global.ng.cdk.coercion, global.ng.mosaic.core, global.ng.mosaic.formField, global.ng.animations, global.ng.forms, global.ng.mosaic.input));
}(this, (function (exports, overlay, portal, common, core, a11y, button, icon, datetime, rxjs, bidi, keycodes, operators, coercion, core$1, formField, animations, forms, input) { 'use strict';
