...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@ptsecurity/cdk/bidi'), require('@ptsecurity/cdk/datetime'), require('@ptsecurity/cdk/keycodes'), require('@ptsecurity/cdk/portal'), require('@angular/animations'), require('@angular/common'), require('@ptsecurity/cdk/coercion'), require('@ptsecurity/cdk/overlay'), require('@ptsecurity/mosaic/core'), require('@ptsecurity/mosaic/form-field'), require('@angular/forms'), require('@ptsecurity/mosaic/input'), require('@ptsecurity/mosaic/button'), require('@ptsecurity/cdk/a11y'), require('@ptsecurity/mosaic/icon')) :
	typeof define === 'function' && define.amd ? define('@ptsecurity/mosaic/datepicker', ['exports', '@angular/core', 'rxjs', 'rxjs/operators', '@ptsecurity/cdk/bidi', '@ptsecurity/cdk/datetime', '@ptsecurity/cdk/keycodes', '@ptsecurity/cdk/portal', '@angular/animations', '@angular/common', '@ptsecurity/cdk/coercion', '@ptsecurity/cdk/overlay', '@ptsecurity/mosaic/core', '@ptsecurity/mosaic/form-field', '@angular/forms', '@ptsecurity/mosaic/input', '@ptsecurity/mosaic/button', '@ptsecurity/cdk/a11y', '@ptsecurity/mosaic/icon'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.mosaic = global.ng.mosaic || {}, global.ng.mosaic.datepicker = {}),global.ng.core,global.rxjs,global.rxjs.operators,global.ng.cdk.bidi,global.ng.cdk.datetime,global.ng.cdk.keycodes,global.ng.cdk.portal,global.ng.animations,global.ng.common,global.ng.cdk.coercion,global.ng.cdk.overlay,global.ng.mosaic.core,global.ng.mosaic.formField,global.ng.forms,global.ng.mosaic.input,global.ng.mosaic.button,global.ng.cdk.a11y,global.ng.mosaic.icon));
}(this, (function (exports,core,rxjs,operators,bidi,datetime,keycodes,portal,animations,common,coercion,overlay,core$1,formField,forms,input,button,a11y,icon) { 'use strict';
...
var McDatepicker = /** @class */ (function () {
     ...
     */
    McDatepicker.prototype.registerInput = function (input$$1) {
        var _this = this;
    ...
    McDatepicker = McDatepicker_1 = __decorate([
        core.Component({
            ...
            changeDetection: core.ChangeDetectionStrategy.OnPush,
            encapsulation: core.ViewEncapsulation.None,
            providers: [{ provide: formField.McFormFieldControl, useExisting: McDatepicker_1 }]
        }),
    ...
    McDatepickerInput = McDatepickerInput_1 = __decorate([
        core.Directive({
            ...
            providers: [
                ...
                { provide: input.MC_INPUT_VALUE_ACCESSOR, useExisting: McDatepickerInput_1 }
            ],
            host: {
        ...
        __param(3, core.Optional()),
        __metadata("design:paramtypes", [core.ElementRef,
            datetime.DateAdapter, Object, formField.McFormField])
    ], McDatepickerInput);
...
var McDatepickerToggle = /** @class */ (function () {
    ...
    __decorate([
        ...
        __metadata("design:type", button.McButton)
