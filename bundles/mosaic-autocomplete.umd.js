...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/coercion'), require('@angular/core'), require('@ptsecurity/cdk/a11y'), require('@ptsecurity/mosaic/core'), require('@angular/cdk/bidi'), require('@angular/common'), require('@angular/forms'), require('@ptsecurity/cdk/keycodes'), require('@angular/cdk/overlay'), require('@angular/cdk/portal'), require('@angular/cdk/scrolling'), require('@ptsecurity/mosaic/form-field'), require('rxjs'), require('rxjs/operators')) :
	typeof define === 'function' && define.amd ? define('@ptsecurity/mosaic/autocomplete', ['exports', '@angular/cdk/coercion', '@angular/core', '@ptsecurity/cdk/a11y', '@ptsecurity/mosaic/core', '@angular/cdk/bidi', '@angular/common', '@angular/forms', '@ptsecurity/cdk/keycodes', '@angular/cdk/overlay', '@angular/cdk/portal', '@angular/cdk/scrolling', '@ptsecurity/mosaic/form-field', 'rxjs', 'rxjs/operators'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.mosaic = global.ng.mosaic || {}, global.ng.mosaic.autocomplete = {}),global.ng.cdk.coercion,global.ng.core,global.ng.cdk.a11y,global.ng.mosaic.core,global.ng.cdk.bidi,global.ng.common,global.ng.forms,global.ng.cdk.keycodes,global.ng.cdk.overlay,global.ng.cdk.portal,global.ng.cdk.scrolling,global.ng.mosaic.formField,global.rxjs,global.rxjs.operators));
}(this, (function (exports,coercion,core,a11y,core$1,bidi,common,forms,keycodes,overlay,portal,scrolling,formField,rxjs,operators) { 'use strict';
