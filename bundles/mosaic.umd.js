...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@ptsecurity/cdk/bidi'), require('@ptsecurity/cdk/coercion'), require('rxjs'), require('@angular/common'), require('@ptsecurity/cdk/keycodes'), require('@angular/animations'), require('@ptsecurity/cdk/a11y'), require('@ptsecurity/cdk/platform'), require('@angular/forms'), require('@ptsecurity/cdk/portal'), require('rxjs/operators'), require('@ptsecurity/cdk/overlay'), require('@ptsecurity/cdk/collections'), require('@ptsecurity/cdk/tree'), require('@ptsecurity/cdk/scrolling'), require('@angular/platform-browser/animations')) :
	typeof define === 'function' && define.amd ? define('@ptsecurity/mosaic', ['exports', '@angular/core', '@ptsecurity/cdk/bidi', '@ptsecurity/cdk/coercion', 'rxjs', '@angular/common', '@ptsecurity/cdk/keycodes', '@angular/animations', '@ptsecurity/cdk/a11y', '@ptsecurity/cdk/platform', '@angular/forms', '@ptsecurity/cdk/portal', 'rxjs/operators', '@ptsecurity/cdk/overlay', '@ptsecurity/cdk/collections', '@ptsecurity/cdk/tree', '@ptsecurity/cdk/scrolling', '@angular/platform-browser/animations'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.mosaic = {}),global.ng.core,global.ng.cdk.bidi,global.ng.cdk.coercion,global.rxjs,global.ng.common,global.ng.cdk.keycodes,global.ng.animations,global.ng.cdk.a11y,global.ng.cdk.platform,global.ng.forms,global.ng.cdk.portal,global.rxjs.operators,global.ng.cdk.overlay,global.ng.cdk.collections,global.ng.cdk.tree,global.ng.cdk.scrolling,global.ng.platformBrowser.animations));
}(this, (function (exports,core,bidi,coercion,rxjs,common,keycodes,animations,a11y,platform,forms,portal,operators,overlay,collections,tree,scrolling,animations$1) { 'use strict';
...
var McTabBody = /** @class */ (function () {
    ...
    McTabBody = __decorate([
        core.Component({
            ...
            styles: [".mc-tab-body__content{height:100%;overflow:auto}.mc-tab-group_dynamic-height .mc-tab-body__content{overflow:hidden}"],
            encapsulation: core.ViewEncapsulation.None,
            changeDetection: core.ChangeDetectionStrategy.OnPush,
...
var McTabGroup = /** @class */ (function (_super) {
    ...
    function McTabGroup(elementRef, changeDetectorRef, defaultConfig) {
        var _this = _super.call(this, elementRef) || this;
        _this.changeDetectorRef = changeDetectorRef;
    ...
    McTabGroup = __decorate([
        core.Component({
            ...
            exportAs: 'mcTabGroup',
            template: "<mc-tab-header #tabHeader [selectedIndex]=\"selectedIndex\" (indexFocused)=\"focusChanged($event)\" (selectFocusedIndex)=\"selectedIndex = $event\"><div class=\"mc-tab-label\" role=\"tab\" mcTabLabelWrapper cdkMonitorElementFocus *ngFor=\"let tab of tabs; let i = index\" [id]=\"getTabLabelId(i)\" [attr.tabIndex]=\"getTabIndex(tab, i)\" [attr.aria-posinset]=\"i + 1\" [attr.aria-setsize]=\"tabs.length\" [attr.aria-controls]=\"getTabContentId(i)\" [attr.aria-selected]=\"selectedIndex == i\" [attr.aria-label]=\"tab.ariaLabel || null\" [attr.aria-labelledby]=\"(!tab.ariaLabel && tab.ariaLabelledby) ? tab.ariaLabelledby : null\" [class.mc-tab-label_active]=\"selectedIndex == i\" [disabled]=\"tab.disabled\" (click)=\"handleClick(tab, tabHeader, i)\"><div class=\"mc-tab-label-content\"><ng-template [ngIf]=\"tab.templateLabel\"><ng-template [cdkPortalOutlet]=\"tab.templateLabel\"></ng-template></ng-template><ng-template [ngIf]=\"!tab.templateLabel\">{{tab.textLabel}}</ng-template></div></div></mc-tab-header><div class=\"mc-tab-body__wrapper\" #tabBodyWrapper><mc-tab-body role=\"tabpanel\" *ngFor=\"let tab of tabs; let i = index\" [id]=\"getTabContentId(i)\" [attr.aria-labelledby]=\"getTabLabelId(i)\" [class.mc-tab-body__active]=\"selectedIndex == i\" [content]=\"tab.content\" [position]=\"tab.position\" [origin]=\"tab.origin\" [animationDuration]=\"animationDuration\" (onCentered)=\"removeTabBodyWrapperHeight()\" (onCentering)=\"setTabBodyWrapperHeight($event)\"></mc-tab-body></div>",
            styles: [".mc-tab-group.mc-tab-group_light .mc-tab-label.cdk-keyboard-focused:after,.mc-tab-group.mc-tab-group_light .mc-tab-label.mc-tab-label_active:before,.mc-tab-group.mc-tab-group_light .mc-tab-label:hover:before,.mc-tab-group:not(.mc-tab-group_light) .mc-tab-label.cdk-keyboard-focused:after{display:block;position:absolute;content:\"\"}.mc-tab-group.mc-tab-group_light .mc-tab-label.mc-tab-label_active:before,.mc-tab-group.mc-tab-group_light .mc-tab-label:hover:before{bottom:-1px;left:0;height:4px;right:0}.mc-tab-group{display:flex;flex-direction:column;box-sizing:border-box;text-align:center;white-space:nowrap}.mc-tab-group:focus{outline:0}.mc-tab-group.mc-tab_disabled{cursor:default}.mc-tab-group.mc-tab-group_inverted-header{flex-direction:column-reverse}.mc-tab-group:not(.mc-tab-group_light) .mc-tab-label{display:inline-flex;height:40px;box-sizing:border-box;text-align:center;justify-content:center;align-items:center;white-space:nowrap;cursor:pointer;padding-right:16px;padding-left:16px;outline:0;border-bottom-width:1px;border-bottom-style:solid;border-top-width:1px;border-top-style:solid;border-top-left-radius:3px;border-top-right-radius:3px}.mc-tab-group:not(.mc-tab-group_light) .mc-tab-label.cdk-keyboard-focused{position:relative}.mc-tab-group:not(.mc-tab-group_light) .mc-tab-label.cdk-keyboard-focused:after{top:-2px;right:-1px;bottom:-1px;left:-1px;border-width:2px;border-style:solid;border-top-left-radius:3px;border-top-right-radius:3px;border-bottom:none}.mc-tab-group:not(.mc-tab-group_light) .mc-tab-label.mc-tab_disabled{pointer-events:none;cursor:auto}.mc-tab-group:not(.mc-tab-group_light) .mc-tab-label.mc-tab-label_active{padding-right:15px;padding-left:15px;border-width:1px;border-style:solid}.mc-tab-group:not(.mc-tab-group_light) .mc-tab-label.mc-tab-label_active.cdk-keyboard-focused{border-color:transparent}.mc-tab-group:not(.mc-tab-group_light) .mc-tab-label.mc-tab-label_active.cdk-keyboard-focused:after{right:-2px;left:-2px}.mc-tab-group.mc-tab-group_light .mc-tab-label{display:inline-flex;height:40px;box-sizing:border-box;text-align:center;justify-content:center;align-items:center;white-space:nowrap;cursor:pointer;padding-right:16px;padding-left:16px;outline:0;border-bottom-width:1px;border-bottom-style:solid}.mc-tab-group.mc-tab-group_light .mc-tab-label.cdk-keyboard-focused{position:relative}.mc-tab-group.mc-tab-group_light .mc-tab-label.cdk-keyboard-focused:after{top:-2px;right:-1px;bottom:-1px;left:-1px;border-width:2px;border-style:solid;border-top-left-radius:3px;border-top-right-radius:3px;border-bottom:none}.mc-tab-group.mc-tab-group_light .mc-tab-label.mc-tab_disabled{pointer-events:none;cursor:auto}.mc-tab-group.mc-tab-group_light .mc-tab-label.mc-tab-label_active,.mc-tab-group.mc-tab-group_light .mc-tab-label:hover{position:relative}.mc-tab-group.mc-tab-group_light .mc-tab-label.cdk-keyboard-focused+:hover:before{left:1px}.mc-tab-group.mc-tab-group_light .mc-tab-label.cdk-keyboard-focused:after{top:-1px}.mc-tab-header__content{padding:1px 1px 0 1px}.mc-tab-body__wrapper{display:flex;overflow:hidden;position:relative}.mc-tab-body{top:0;left:0;right:0;bottom:0;position:absolute;display:block;overflow:hidden;flex-basis:100%}.mc-tab-body.mc-tab-body__active{overflow-x:hidden;overflow-y:auto;position:relative;z-index:1;flex-grow:1}.mc-tab-group.mc-tab-group_dynamic-height .mc-tab-body.mc-tab-body__active{overflow-y:hidden}"],
            encapsulation: core.ViewEncapsulation.None,
            changeDetection: core.ChangeDetectionStrategy.OnPush,
            inputs: ['color'],
            host: {
        ...
        __param(2, core.Inject(MC_TABS_CONFIG)), __param(2, core.Optional()),
        __metadata("design:paramtypes", [core.ElementRef,
            core.ChangeDetectorRef, Object])
    ], McTabGroup);
    return McTabGroup;
...
var McTabNav = /** @class */ (function (_super) {
    ...
    McTabNav = __decorate([
        core.Component({
            ...
            styles: [".mc-tab-nav-bar.mc-tab-group_light .mc-tab-link.cdk-keyboard-focused:after,.mc-tab-nav-bar.mc-tab-group_light .mc-tab-link.mc-tab-label_active:before,.mc-tab-nav-bar.mc-tab-group_light .mc-tab-link:hover:before,.mc-tab-nav-bar:not(.mc-tab-group_light) .mc-tab-link.cdk-keyboard-focused:after{display:block;position:absolute;content:\"\"}.mc-tab-nav-bar.mc-tab-group_light .mc-tab-link.mc-tab-label_active:before,.mc-tab-nav-bar.mc-tab-group_light .mc-tab-link:hover:before{bottom:-1px;left:0;height:4px;right:0}.mc-tab-link{vertical-align:top;text-decoration:none;-webkit-tap-highlight-color:transparent}.mc-tab-group_stretch-labels .mc-tab-link{flex-basis:0;flex-grow:1}.mc-tab-link.mc-tab_disabled{pointer-events:none}.mc-tab-nav-bar{display:flex}.mc-tab-nav-bar:not(.mc-tab-group_light) .mc-tab-link{display:inline-flex;height:40px;box-sizing:border-box;text-align:center;justify-content:center;align-items:center;white-space:nowrap;cursor:pointer;padding-right:16px;padding-left:16px;outline:0;border-bottom-width:1px;border-bottom-style:solid;border-top-width:1px;border-top-style:solid;border-top-left-radius:3px;border-top-right-radius:3px}.mc-tab-nav-bar:not(.mc-tab-group_light) .mc-tab-link.cdk-keyboard-focused{position:relative}.mc-tab-nav-bar:not(.mc-tab-group_light) .mc-tab-link.cdk-keyboard-focused:after{top:-2px;right:-1px;bottom:-1px;left:-1px;border-width:2px;border-style:solid;border-top-left-radius:3px;border-top-right-radius:3px;border-bottom:none}.mc-tab-nav-bar:not(.mc-tab-group_light) .mc-tab-link.mc-tab_disabled{pointer-events:none;cursor:auto}.mc-tab-nav-bar:not(.mc-tab-group_light) .mc-tab-link.mc-tab-label_active{padding-right:15px;padding-left:15px;border-width:1px;border-style:solid}.mc-tab-nav-bar:not(.mc-tab-group_light) .mc-tab-link.mc-tab-label_active.cdk-keyboard-focused{border-color:transparent}.mc-tab-nav-bar:not(.mc-tab-group_light) .mc-tab-link.mc-tab-label_active.cdk-keyboard-focused:after{right:-2px;left:-2px}.mc-tab-nav-bar.mc-tab-group_light .mc-tab-link{display:inline-flex;height:40px;box-sizing:border-box;text-align:center;justify-content:center;align-items:center;white-space:nowrap;cursor:pointer;padding-right:16px;padding-left:16px;outline:0;border-bottom-width:1px;border-bottom-style:solid}.mc-tab-nav-bar.mc-tab-group_light .mc-tab-link.cdk-keyboard-focused{position:relative}.mc-tab-nav-bar.mc-tab-group_light .mc-tab-link.cdk-keyboard-focused:after{top:-2px;right:-1px;bottom:-1px;left:-1px;border-width:2px;border-style:solid;border-top-left-radius:3px;border-top-right-radius:3px;border-bottom:none}.mc-tab-nav-bar.mc-tab-group_light .mc-tab-link.mc-tab_disabled{pointer-events:none;cursor:auto}.mc-tab-nav-bar.mc-tab-group_light .mc-tab-link.mc-tab-label_active,.mc-tab-nav-bar.mc-tab-group_light .mc-tab-link:hover{position:relative}.mc-tab-nav-bar.mc-tab-group_light .mc-tab-link.cdk-keyboard-focused+:hover:before{left:1px}.mc-tab-nav-bar.mc-tab-group_light .mc-tab-link.cdk-keyboard-focused:after{top:-1px}.mc-tab-links{display:flex;position:relative;padding:1px 1px 0 1px;flex-grow:1}.mc-tab-group_align-labels-center .mc-tab-links{justify-content:center}.mc-tab-group_align-labels-end .mc-tab-links{justify-content:flex-end}"],
...
exports.ɵd23 = MAX_VALIDATOR;
exports.ɵb23 = MIN_VALIDATOR;
exports.ɵe23 = MaxValidator;
exports.ɵc23 = MinValidator;
exports.ɵa23 = MC_INPUT_VALUE_ACCESSOR;
