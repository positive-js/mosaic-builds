...
/*! *****************************************************************************
    ...
    ***************************************************************************** */var a=function(e,r){return(a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(e,r){e.__proto__=r}||function(e,r){for(var t in r)Object.prototype.hasOwnProperty.call(r,t)&&(e[t]=r[t])})(e,r)};Object.create;Object.create;var i=0,s=function(e){this._elementRef=e};var c=o.mixinColor(s,o.ThemePalette.Primary),p=function(e){function r(r){var t=e.call(this,r)||this;return t.id="mc-progress-bar-"+i++,t.value=0,t.mode="determinate",t}return function(e,r){function t(){this.constructor=e}a(e,r),e.prototype=null===r?Object.create(r):(t.prototype=r.prototype,new t)}(r,e),Object.defineProperty(r.prototype,"percentage",{get:function(){return Math.max(0,Math.min(100,this.value))/100},enumerable:!1,configurable:!0}),r}(c);p.decorators=[{type:n.Component,args:[{selector:"mc-progress-bar",template:'\n<div class="mc-progress-bar__inner" [ngSwitch]="mode" [id]="id">\n    <div\n        *ngSwitchCase="\'indeterminate\'"\n        class="mc-progress-bar__line mc-progress-bar__line--indeterminate">\n    </div>\n    <div\n        *ngSwitchDefault\n        class="mc-progress-bar__line mc-progress-bar__line--determinate"\n        [ngStyle]="{transform: \'scaleX(\' + percentage + \')\'}">\n    </div>\n</div>\n',changeDetection:n.ChangeDetectionStrategy.OnPush,encapsulation:n.ViewEncapsulation.None,inputs:["color"],host:{class:"mc-progress-bar","[attr.id]":"id"},styles:["@-webkit-keyframes mc-progress-bar-indeterminate{0%{transform:scaleX(.25) translateX(-150%)}to{transform:scaleX(.4) translateX(250%)}}@keyframes mc-progress-bar-indeterminate{0%{transform:scaleX(.25) translateX(-150%)}to{transform:scaleX(.4) translateX(250%)}}.mc-progress-bar{display:block;height:var(--mc-progress-bar-size-height,4px);overflow:hidden}.mc-progress-bar__inner{height:100%}.mc-progress-bar__line{height:100%;transform-origin:top left}.mc-progress-bar__line--determinate{transition:transform .3s}.mc-progress-bar__line--indeterminate{-webkit-animation:mc-progress-bar-indeterminate 2.1s cubic-bezier(.455,.03,.515,.955) infinite;animation:mc-progress-bar-indeterminate 2.1s cubic-bezier(.455,.03,.515,.955) infinite}"]}]}],p.ctorParameters=function(){return[{type:n.ElementRef}]},p.propDecorators={id:[{type:n.Input}],value:[{type:n.Input}],mode:[{type:n.Input}]};var m=function(){};m.decorators=[{type:n.NgModule,args:[{imports:[t.CommonModule,r.PlatformModule],exports:[p],declarations:[p]}]}],e.McProgressBar=p,e.McProgressBarBase=s,e.McProgressBarMixinBase=c,e.McProgressBarModule=m,Object.defineProperty(e,"__esModule",{value:!0})}));
